...
namespace UnityEditor.Tilemaps
{
    internal static class DefaultAssetCreation
    {
        ...
        private const int k_TilePaletteWhiteboxAssetMenuPriority = k_TilePaletteAssetMenuPriority + 100;
        ...
        [MenuItem("Assets/Create/2D/Tile Palette/Hexagonal Point Top", priority = k_TilePaletteAssetMenuPriority)]
